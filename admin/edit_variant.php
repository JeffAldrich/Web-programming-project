...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    */
    ...
    } elseif (!ctype_digit($stock_input)) {
    ...
    if ($error === "") {
        ...
        if (!$stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                $error =
                    "This size and color combination already exists for this product.";
...
<head>
    ...
    <title>JAC Admin - Edit Variant</title>
